...
resource "aws_s3_bucket_acl" "cloudfront_logs_acl" {
  bucket = "edo-cloudfront-891377135193"  # or your current ACL; this is just to ensure ACLs are active
...
resource "aws_s3_bucket_public_access_block" "cloudfront_logs" {
  bucket = "edo-cloudfront-891377135193"
    ...
    Statement = [
      {
        ...
        Action    = "s3:PutObject"
        Resource  = "arn:aws:s3:::edo-cloudfront-891377135193/*"
      }
    ]
  })
}