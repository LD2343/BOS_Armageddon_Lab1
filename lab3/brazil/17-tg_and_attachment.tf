...
resource "aws_lb_target_group" "brazil_tg01" {
...
resource "aws_lb_target_group_attachment" "brazil_tg_attach01" {
  target_group_arn = aws_lb_target_group.brazil_tg01.arn
  target_id        = aws_instance.brazil_ec201_private_bonus.id
  port             = 80
