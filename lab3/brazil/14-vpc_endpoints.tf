...
#   tags = {
#     Name = "${local.gru_prefix}-vpce-s3-gw01"
#   }
# }
...
# # Explanation: CloudWatch Logs is the ship’s black box—gro wants crash data, always.
...
#   tags = {
#     Name = "${local.gru_prefix}-vpce-logs01"
#   }
# }
...
# # Explanation: Secrets Manager is the locked vault—gro doesn’t put passwords on sticky notes.
...
# # Explanation: KMS is the encryption kyber crystal—gro prefers locked doors AND locked safes.
